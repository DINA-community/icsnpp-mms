...
static asn_TYPE_member_t asn_MBR_executionArgument_9[] = {
...
static const asn_TYPE_tag2member_t asn_MAP_executionArgument_tag2el_9[] = {
    { (ASN_TAG_CLASS_UNIVERSAL | (8 << 2)), 1, 0, 0 }, /* encodedString */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 0, 0, 0 } /* simpleString */
};
static asn_CHOICE_specifics_t asn_SPC_executionArgument_specs_9 = {
	...
	asn_MAP_executionArgument_tag2el_9,
	2,	/* Count of tags in the map */
	0,
	-1	/* Extensions start */
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_executionArgument_9 = {
	"executionArgument",
	"executionArgument",
	CHOICE_free,
	CHOICE_print,
	...
	0,	/* No tags (count) */
	0,	/* No PER visible constraints */
	asn_MBR_executionArgument_9,
	2,	/* Elements count */
	&asn_SPC_executionArgument_specs_9	/* Additional specs */
};
...
static asn_TYPE_member_t asn_MBR_GetProgramInvocationAttributes_Response_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct GetProgramInvocationAttributes_Response, startArgument),
	...
	{ ATF_POINTER, 1, offsetof(struct GetProgramInvocationAttributes_Response, executionArgument),
		-1 /* Ambiguous tag (CHOICE?) */,
		0,
		&asn_DEF_executionArgument_9,
		0,	/* Defer constraints checking to the member type */
		0,	/* PER is not compiled, use -gen-PER */
		0,
		"executionArgument"
...
static const asn_TYPE_tag2member_t asn_MAP_GetProgramInvocationAttributes_Response_tag2el_1[] = {
    { (ASN_TAG_CLASS_UNIVERSAL | (8 << 2)), 6, 0, 0 }, /* encodedString */
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* state */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 1 }, /* listOfDomainNames */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 6, -1, 0 }, /* simpleString */
    ...
    { (ASN_TAG_CLASS_CONTEXT | (5 << 2)), 5, 0, 0 } /* startArgument */
};
