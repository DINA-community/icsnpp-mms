...
static asn_TYPE_member_t asn_MBR_GetEventConditionAttributes_Response_1[] = {
	...
	{ ATF_POINTER, 5, offsetof(struct GetEventConditionAttributes_Response, prio_rity),
	...
	{ ATF_POINTER, 4, offsetof(struct GetEventConditionAttributes_Response, severity),
	...
	{ ATF_POINTER, 3, offsetof(struct GetEventConditionAttributes_Response, alarmSummaryReports),
	...
	{ ATF_POINTER, 2, offsetof(struct GetEventConditionAttributes_Response, monitoredVariable),
	...
	{ ATF_POINTER, 1, offsetof(struct GetEventConditionAttributes_Response, evaluationInterval),
...
static const asn_TYPE_tag2member_t asn_MAP_GetEventConditionAttributes_Response_tag2el_1[] = {
    ...
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 }, /* prio-rity */
