...
/* Dependencies */
typedef enum GetAlarmSummary_Request__acknowledgmentFilter {
	GetAlarmSummary_Request__acknowledgmentFilter_not_acked	= 0,
	GetAlarmSummary_Request__acknowledgmentFilter_acked	= 1,
	GetAlarmSummary_Request__acknowledgmentFilter_all	= 2
} e_GetAlarmSummary_Request__acknowledgmentFilter;
