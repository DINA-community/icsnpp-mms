...
typedef enum ServiceError__errorClass__vmdState {
	...
	ServiceError__errorClass__vmdState_vmd_state_conflict	= 1,
	ServiceError__errorClass__vmdState_vmd_operational_problem	= 2,
	ServiceError__errorClass__vmdState_domain_transfer_problem	= 3,
	ServiceError__errorClass__vmdState_state_machine_id_invalid	= 4
...
typedef enum ServiceError__errorClass__applicationReference {
	...
	ServiceError__errorClass__applicationReference_aplication_unreachable	= 1,
	ServiceError__errorClass__applicationReference_connection_lost	= 2,
	ServiceError__errorClass__applicationReference_application_reference_invalid	= 3,
	ServiceError__errorClass__applicationReference_context_unsupported	= 4
...
typedef enum ServiceError__errorClass__timeResolution {
	...
	ServiceError__errorClass__timeResolution_unsupportable_time_resolution	= 1
...
typedef enum ServiceError__errorClass__file {
	...
	ServiceError__errorClass__file_filename_syntaxError	= 3,
