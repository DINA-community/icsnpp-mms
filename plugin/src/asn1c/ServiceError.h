...
typedef enum ServiceError__errorClass__service {
	...
	ServiceError__errorClass__service_object_sate_conflict	= 2,
...
typedef enum ServiceError__serviceSpecificInformation_PR {
	ServiceError__serviceSpecificInformation_PR_NOTHING,	/* No components present */
	ServiceError__serviceSpecificInformation_PR_obtainFile,
	ServiceError__serviceSpecificInformation_PR_start,
	ServiceError__serviceSpecificInformation_PR_stop,
	ServiceError__serviceSpecificInformation_PR_resume,
	ServiceError__serviceSpecificInformation_PR_reset,
...
} ServiceError__serviceSpecificInformation_PR;
...
typedef struct ServiceError {
	...
	struct ServiceError__serviceSpecificInformation {
		ServiceError__serviceSpecificInformation_PR present;
		union ServiceError__serviceSpecificInformation_u {
