...
static asn_TYPE_member_t asn_MBR_InitResponseDetail_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct InitResponseDetail, negociatedVersionNumber),
		...
		0,
		"negociatedVersionNumber"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct InitResponseDetail, negociatedParameterCBB),
...
static const asn_TYPE_tag2member_t asn_MAP_InitResponseDetail_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* negociatedVersionNumber */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* negociatedParameterCBB */
