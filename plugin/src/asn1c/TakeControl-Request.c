...
static asn_TYPE_member_t asn_MBR_TakeControl_Request_1[] = {
	...
	{ ATF_POINTER, 6, offsetof(struct TakeControl_Request, namedToken),
	...
	{ ATF_POINTER, 5, offsetof(struct TakeControl_Request, priority),
	...
	{ ATF_POINTER, 4, offsetof(struct TakeControl_Request, acceptableDelay),
	...
	{ ATF_POINTER, 3, offsetof(struct TakeControl_Request, controlTimeOut),
	...
	{ ATF_POINTER, 2, offsetof(struct TakeControl_Request, abortOnTimeOut),
	...
	{ ATF_POINTER, 1, offsetof(struct TakeControl_Request, relinquishIfConnectionLost),
