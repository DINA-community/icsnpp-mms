...
static asn_TYPE_member_t asn_MBR_Unconfirmed_PDU_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct Unconfirmed_PDU, unconfirmedService),
	...
	{ ATF_POINTER, 1, offsetof(struct Unconfirmed_PDU, cs_request_detail),
...
static const asn_TYPE_tag2member_t asn_MAP_Unconfirmed_PDU_tag2el_1[] = {
    ...
    { (ASN_TAG_CLASS_CONTEXT | (79 << 2)), 1, 0, 0 } /* cs-request-detail */
};
